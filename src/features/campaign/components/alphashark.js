      ...
      <Card id="card1">
        <Box sx={{ display: 'flex', flexDirection: 'row'}}>
          <CardMedia
            component="img"
            height="300"
            image={'/static/images/campaign/alphashark/1.png'}
            alt="AlphaShark"
          />
        </Box>
        <CardHeader
          title="Rius Bot ⓧ AlphShark 1"
      ...
      <Card id="3">
        <Box sx={{ display: 'flex', flexDirection: 'row'}}>
          <CardMedia
            component="img"
            height="200"
            image={'/static/images/campaign/alphashark/3.png'}
            alt="AlphaShark"
          />
        </Box>
        <CardHeader
          title="Rius Bot ⓧ AlphShark 3"
          subheader="Check it out !!!"
          id="AlphaShark"
        />
        <Divider />
      ...
      <Card id="4">
        <Box sx={{ display: 'flex', flexDirection: 'row'}}>
          <CardMedia
            component="img"
            height="400"
            image={'/static/images/campaign/alphashark/4.png'}
            alt="AlphaShark"
          />
        </Box>
        <CardHeader
          title="Rius Bot ⓧ AlphShark 4"
          subheader="Check it out !!!"
          id="AlphaShark"
        />
        <Divider />
      ...
      <Card id="2_small">
        <Box sx={{ display: 'flex', flexDirection: 'row'}}>
          <img
            ...
            src="/static/images/campaign/alphashark/2.png"
            style={{
        ...
        <CardHeader
          title="Rius Bot ⓧ AlphShark 2 small"
          subheader="Check it out !!!"
          id="AlphaShark"
        />
        <Divider />
